            ...
            return (
                <div className="module-main-sidebar">
                    ...
                    <div className="buttons">
                        {
                            isAdmin ?
                                <IconButton width={40} height={40} icon="administrator" iconSize={28} onClick={this.toggleAdminDialog} />
                                :
                                null
                        }
                        ...
                        <IconButton width={40} height={40} icon="app" iconSize={28} onClick={this.toggleAppDownloadDialog} />
                        <IconButton width={40} height={40} icon="dashang" iconSize={26} onClick={this.toggleRewardDialog} />
                        <IconButton width={40} height={40} icon="about" iconSize={26} onClick={this.toggleInfoDialog} />
                        <IconButton width={40} height={40} icon="setting" iconSize={26} onClick={this.toggleSettingDialog} />
