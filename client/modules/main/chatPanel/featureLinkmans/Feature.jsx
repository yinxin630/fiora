    ...
    renderSearchUsers(count = 999) {
        ...
        for (let i = 0; i < count; i++) {
            usersDom.push(
                <div
                    key={users[i]._id}
                    onClick={this.openUserInfoDialog.bind(this, users[i])}
                    role="button"
                >
    ...
    renderSearchGroups(count = 999) {
        ...
        for (let i = 0; i < count; i++) {
            groupsDom.push(
                <div
                    key={groups[i]._id}
                    onClick={this.openGroupInfoDialog.bind(this, groups[i])}
                    role="button"
                >
            ...
            <div className="chatPanel-feature">
                ...
                >
                    <div className="content">
                        ...
                        />
                        <button onClick={this.handleCreateGroup} type="button">
                            创建
                        </button>
                    </div>
                </Dialog>
                            ...
                            <div className="all-list">
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            display:
                                                searchResult.users.length > 3 ? 'block' : 'none',
                                        }}
                                    >
                                        <span onClick={this.switchTabToUser} role="button">
                                            查看更多
                                        </span>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            display:
                                                searchResult.groups.length > 3 ? 'block' : 'none',
                                        }}
                                    >
                                        <span onClick={this.switchTabToGroup} role="button">
                                            查看更多
                                        </span>
                                    </div>
                                </div>
                ...
                <GroupInfo
                    ...
                    groupInfo={groupInfo}
                    onClose={this.toggleGroupInfoDialog}
                />
                <UserInfo
                    visible={userInfoDialog}
                    userInfo={userInfo}
                    onClose={this.toggleUserInfoDialog}
                />
            </div>
        );
    }
